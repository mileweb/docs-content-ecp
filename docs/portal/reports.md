...
| Service Zone             | Select one or more [service zone](<Zones.htm>) options. <ul><li><strong>Standard</strong> = standard service zone.</li><li><strong>Business</strong> = business service zone. (*default*).</li><li><strong>Premium</strong> = premium service zone.</strong></li>                                                                        |
